...
public class MenuFXMLController implements Initializable {
    ...
    private void addArtist(MouseEvent event) {
        try {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("AddArtistFXML.fxml"));
    ...
    private void addFavourite(MouseEvent event) {
         ...
         try {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("AddFavFXML.fxml"));
        Parent root = loader.load(); 
        Scene scene = new Scene(root);
        Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
        stage.setScene(scene);
    ...
    private void displayFav(MouseEvent event) {
        try {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("dashboardFavFXML.fxml"));
        Parent root = loader.load(); 
        Scene scene = new Scene(root);
        Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
        stage.setScene(scene);
