...
public class UtilisateurFXMLController implements Initializable {
    ...
    private void LoginBTN(ActionEvent event) throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("../login/imNotARobotFXML.fxml"));
    ...
    private void forgetPasswordBTN(ActionEvent event) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("../login/forgetPasswordFXML.fxml"));
            Scene scene = new Scene(root);
            Stage primaryStage2 = new Stage();
            primaryStage2.setTitle("Offre");
            primaryStage2.setScene(scene);
    ...
    private void registerBTN(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("../frontOffice/RegisterFXML.fxml"));
