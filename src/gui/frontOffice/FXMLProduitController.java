...
public class FXMLProduitController implements Initializable {
    ...
    private Produit chosenProduct;
   
    @FXML
    void addToCart(ActionEvent event) throws MessagingException {
        
        System.out.println(this.chosenProduct.getLibelle());
        mail.sendMail("marwen.mamlouk@esprit.tn", chosenProduct.getId(), chosenProduct.getLibelle());
    ...
    fxmlLoader.setLocation(getClass().getResource("FXMLitem.fxml"));
