...
public class Mailservice {
    ...
    public void sendMail(String recipient, int idProduit, String libelleProduit) {
         ...
         */
        String host = "marwen.mamlouk@esprit.tn";  //← my email address
        final String user = "marwen.mamlouk@esprit.tn";//← my email address
        final String password = "iopcfremikvtvyqm";//change accordingly   //← my email password
        ...
        try {
            ...
            message.setSubject(" Notification de reponse de Produit !!! ");
            //Text in emial :
            //message.setText("  → Text message for Your Appointement ← ");
            //Html code in email :
            message.setContent(
                    "<h1 style \"color:red\" >Le numero de votre commande est :   " + idProduit + " </h1> "
